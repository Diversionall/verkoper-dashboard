...
if pagina == "Home":
    ...
    with col1:
        st.metric("EAN's totaal (2024)", totaal_2024)
        st.metric("EAN's totaal (2025)", totaal_2025)
    with col2:
        st.metric("Gescrapet (2024)", gescrapet_2024)
        st.metric("Gescrapet (2025)", gescrapet_2025)
    with col3:
        st.metric("Scrape rate (2024)", f"{scrape_rate_2024}%")
        st.metric("Scrape rate (2025)", f"{scrape_rate_2025}%")
