...
st.title("📦 Hoofdcategorieën met 1.000+ klantbezoeken – Omgekeerd gesorteerd")
st.markdown("Aantal producten per hoofdcategorie (winkel) met 1.000+ klantbezoeken. Minder producten onderaan, meer producten bovenaan. Eén blauwe stijl.")
st.markdown("---")
