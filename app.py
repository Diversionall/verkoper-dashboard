...
def load_data():
    ...
    # Klantbezoekskolom zoeken per bestand
    kolom_2024 = zoek_klantbezoekskolom(df_2024)
    kolom_2025 = zoek_klantbezoekskolom(df_2025)

    if not kolom_2024 or not kolom_2025:
        st.error("❌ Kon kolom 'klantbezoeken' niet vinden in één of beide bestanden.")
        st.stop()

    df_2024 = df_2024.rename(columns={kolom_2024: "klantbezoeken"})
    df_2025 = df_2025.rename(columns={kolom_2025: "klantbezoeken"})
