...
# 2. Analyse-pagina
    ...
    # Taartdiagram topmerken met genummerde legenda
    ...
    fig = px.pie(top_n, names='Label', values='Aantal', title="Top Merken in Batch Beide")
    fig.update_layout(legend_title_text="Top Merken")
