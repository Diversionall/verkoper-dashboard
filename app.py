...
if uploaded_file:
    ...
    # ---------------------------
    # ONDERDEEL 1: Pie Chart + verkoperanalyse
    # ---------------------------
    ...
    # ---------------------------
    # ONDERDEEL 2: Winkelanalyse & prijsverschil
    # ---------------------------
    st.markdown("---")
    ...
    min_reviews = st.slider("🧮 Minimaal aantal reviews", 0, 5000, 0, 10)
    ...
    st.dataframe(
        winkel_df.iloc[start_idx:eind_idx][["title", "price", "Relevante Marktprijs", "Prijsverschil%", "rating", "rating_count"]]
    )
