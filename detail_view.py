...
st.set_page_config(page_title="Detail per categorie", layout="wide")

# Teruglink
st.markdown("← [Terug naar hoofdcategorieën](/)", unsafe_allow_html=True)
...
bar_height = 40 * bar_data["productgroep"].nunique()
...
fig_bar.update_layout(
    margin=dict(l=250, r=50, t=60, b=40),
